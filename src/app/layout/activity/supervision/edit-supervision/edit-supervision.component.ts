        ...
        (result) => {
          ...
          this.supervisionService
            ...
            .subscribe(
              (result) => {
                // activity
                this.activityModel = result.data.supervisionActivity;
                //role
                this.selectedSupervisionRole = this.supervisionRoles.find(
                  (supervisionRole) =>
                    supervisionRole.value === this.activityModel.supervisionRole
                );
                // split
                if (this.activityModel.supervisionRole !== 'Supervisor') {
                  this.selectedSplit = this.splits.find(
                    (split) => split.value === this.activityModel.split
                  );
                }
                // student
    ...
    this.supervisionService
      ...
      .subscribe(
        (result) => {
          ...
          this.alertService.successToast('Supervision activity edited');
