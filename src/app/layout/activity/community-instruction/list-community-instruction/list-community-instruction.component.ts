...
export class ListCommunityInstructionComponent implements OnInit {
    ...
    this.communityInstructionService
      ...
      .subscribe(
        (result) => {
          ...
          this.activities = result.data.communityInstructionActivitiesByUser;
        },
        (err) => {
  ...
  onContextEdit(event) {
    ...
    this.router.navigate(
      ['activity/community-instruction/edit', this.selectedActivity.activityId],
      {
        queryParams: {
  ...
  onContextView(event) {
    ...
    this.router.navigate(
      ['activity/community-instruction/view', this.selectedActivity.activityId],
      {
        queryParams: {
          activityId: this.selectedActivity.activityId
        }
