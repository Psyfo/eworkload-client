...
export class ListPersonnelDevelopmentComponent implements OnInit {
  ...
  getActivities() {
    ...
    this.personnelDevelopmentService
      ...
      .subscribe(
        (result) => {
          this.activities = result.data.personnelDevelopmentActivitiesByUser;
        },
        (err) => {
  ...
  onContextView(event) {
    ...
    this.router.navigate(
      ['activity/personnel-development/view', this.selectedActivity.activityId],
      {
        queryParams: {
  ...
  onContextEdit(event) {
    ...
    this.router.navigate(
      ['activity/personnel-development/edit', this.selectedActivity.activityId],
      {
        queryParams: {
          activityId: this.selectedActivity.activityId
        }
